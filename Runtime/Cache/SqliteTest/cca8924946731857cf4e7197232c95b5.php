...
window['App'] =
{
  ...
  path:{
    ...
    controller:'/ThinkAPP/index.php/SqliteTest/Model',
    url:'/ThinkAPP/index.php/SqliteTest/Model',
    action:'/ThinkAPP/index.php/SqliteTest/Model/index',
    safe:'/ThinkAPP/?m=SqliteTest&c=Model',
