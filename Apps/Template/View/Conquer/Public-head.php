...
<div class="header navbar  navbar-fixed-top">
  ...
  <div class="header-inner clearfix">
    ...
    <div class="page-logo">
            <a href="index.html">
                <img src="__TMPL__assets/img/logo.png" alt="logo">
            </a>
        </div>
  ...
  <!-- END LOGO -->
    ...
    <img src="__TMPL__assets/img/menu-toggler.png">
    </a>
    ...
    <ul class="nav navbar-nav pull-right">
          ...
          <li>
            <ul class="dropdown-menu-list scroller" style="height: 250px;">
              <li>
                ...
                <span class="photo">
                <img src="__TMPL__assets/img/avatar2.jpg">
                </span>
                <span class="subject">
                <span class="from">
                Lisa Wong </span>
              ...
              <li>
                <a href="inbox.html?a=view">
                <span class="photo">
                <img src="__TMPL__assets/img/avatar3.jpg">
                </span>
                <span class="subject">
                <span class="from">
                Richard Doe </span>
              ...
              <li>
                <a href="inbox.html?a=view">
                <span class="photo">
                <img src="__TMPL__assets/img/avatar1.jpg">
                </span>
                <span class="subject">
                <span class="from">
                Bob Nilson </span>
      ...
      <li class="dropdown user">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
        <img src="__TMPL__assets/img/avatar3_small.jpg">
        <span class="username">
        Nick </span>
