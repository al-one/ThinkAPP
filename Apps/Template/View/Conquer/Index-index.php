...
<link rel="stylesheet" href="__TMPL__assets/css/pages/tasks.css">
<!-- BEGIN PAGE LEVEL PLUGIN STYLES -->
<link rel="stylesheet" href="__TMPL__assets/plugins/bootstrap-daterangepicker/daterangepicker-bs3.css">
<link rel="stylesheet" href="__TMPL__assets/plugins/fullcalendar/fullcalendar/fullcalendar.css">
<link rel="stylesheet" href="__TMPL__assets/plugins/jqvmap/jqvmap/jqvmap.css">
          ...
          <div class="portlet">
            ...
            <div class="portlet-body">
              <div id="site_statistics_loading">
                <img src="__TMPL__assets/img/loading.gif" alt="loading">
              </div>
                  ...
                  <div class="scroller" style="height: 250px;" data-always-visible="1" data-rail-visible1="1">
                    <div class="row">
                      <div class="col-md-6 user-info">
                        <img alt="" src="__TMPL__assets/img/avatar.png" class="img-responsive">
                        <div class="details">
                          <div>
          ...
          <div class="portlet">
            ...
            <div class="portlet-body" id="chats">
              <div class="scroller" style="height: 435px;" data-always-visible="1" data-rail-visible1="1">
                <ul class="chats">
                  <li class="in">
                    <img class="avatar img-responsive" alt="" src="__TMPL__assets/img/avatar1.jpg">
                    <div class="message">
                      <span class="arrow">
                      </span>
                  ...
                  <li class="out">
                    <img class="avatar img-responsive" alt="" src="__TMPL__assets/img/avatar2.jpg">
                    <div class="message">
                      <span class="arrow">
                      </span>
                  ...
                  <li class="out">
                    <img class="avatar img-responsive" alt="" src="__TMPL__assets/img/avatar3.jpg">
                    <div class="message">
                      <span class="arrow">
                      </span>
...
<script src="__TMPL__assets/plugins/jqvmap/jqvmap/jquery.vmap.js"></script>
<script src="__TMPL__assets/plugins/jqvmap/jqvmap/maps/jquery.vmap.russia.js"></script>
<script src="__TMPL__assets/plugins/jqvmap/jqvmap/maps/jquery.vmap.world.js"></script>
<script src="__TMPL__assets/plugins/jqvmap/jqvmap/maps/jquery.vmap.europe.js"></script>
<script src="__TMPL__assets/plugins/jqvmap/jqvmap/maps/jquery.vmap.germany.js"></script>
<script src="__TMPL__assets/plugins/jqvmap/jqvmap/maps/jquery.vmap.usa.js"></script>
<script src="__TMPL__assets/plugins/jqvmap/jqvmap/data/jquery.vmap.sampledata.js"></script>
<script src="__TMPL__assets/plugins/jquery.peity.min.js"></script>
<script src="__TMPL__assets/plugins/jquery.pulsate.min.js"></script>
<script src="__TMPL__assets/plugins/jquery-knob/js/jquery.knob.js"></script>
...
<script src="__TMPL__assets/plugins/bootstrap-daterangepicker/moment.min.js"></script>
<script src="__TMPL__assets/plugins/bootstrap-daterangepicker/daterangepicker.js"></script>
<script src="__TMPL__assets/plugins/gritter/js/jquery.gritter.js"></script>
<!-- IMPORTANT! fullcalendar depends on jquery-ui-1.10.3.custom.min.js for drag & drop support -->
<script src="__TMPL__assets/plugins/fullcalendar/fullcalendar/fullcalendar.min.js"></script>
<script src="__TMPL__assets/plugins/jquery-easypiechart/jquery.easypiechart.min.js"></script>
<script src="__TMPL__assets/plugins/jquery.sparkline.min.js"></script>
<!-- END PAGE LEVEL PLUGINS -->
<!-- BEGIN PAGE LEVEL SCRIPTS -->
<script src="__TMPL__assets/scripts/index.js"></script>
<script src="__TMPL__assets/scripts/tasks.js"></script>
