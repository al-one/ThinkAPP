...
<include file="Public/head"/>
    <div class="pageheader">
      <h2><i class="fa fa-home"></i> 机构管理 <span>Dashboard</span></h2>
          ...
          <div class="panel panel-success panel-stat">
            <div class="panel-heading">
              ...
              <div class="stat">
                <div class="row">
                  <div class="col-xs-4">
                    <img src="__TMPL__images/is-user.png" alt="" />
                  </div>
                  <div class="col-xs-8">
          ...
          <div class="panel panel-danger panel-stat">
            <div class="panel-heading">
              ...
              <div class="stat">
                <div class="row">
                  <div class="col-xs-4">
                    <img src="__TMPL__images/is-document.png" alt="" />
                  </div>
                  <div class="col-xs-8">
          ...
          <div class="panel panel-dark panel-stat">
            <div class="panel-heading">
              ...
              <div class="stat">
                <div class="row">
                  <div class="col-xs-4">
                    <img src="__TMPL__images/is-money.png" alt="" />
                  </div>
                  <div class="col-xs-8">
      ...
      <div class="row">
        <div class="col-sm-6 col-md-4">
          <div class="panel panel-default widget-photoday">
            <div class="panel-body">
              <a href="" class="photoday"><img src="__TMPL__images/photos/photo1.png" alt="" /></a>
...
<script src="__TMPL__js/flot/jquery.flot.min.js"></script>
<script src="__TMPL__js/flot/jquery.flot.resize.min.js"></script>
<script src="__TMPL__js/flot/jquery.flot.spline.min.js"></script>
<script src="__TMPL__js/morris.min.js"></script>
<script src="__TMPL__js/raphael-2.1.0.min.js"></script>
<script src="__TMPL__js/dashboard.js"></script>
</body>
</html>